export const LBPairAbi = [
  ...
  { inputs: [], name: "BinHelper__MaxLiquidityPerBinExceeded", type: "error" },
  { inputs: [], name: "FeeHelper__FeeTooLarge", type: "error" },
  { inputs: [], name: "Hooks__CallFailed", type: "error" },
  ...
  { inputs: [], name: "LBPair__FlashLoanInsufficientAmount", type: "error" },
  { inputs: [], name: "LBPair__InsufficientAmountIn", type: "error" },
  { inputs: [], name: "LBPair__InsufficientAmountOut", type: "error" },
  { inputs: [], name: "LBPair__InvalidHooks", type: "error" },
  { inputs: [], name: "LBPair__InvalidInput", type: "error" },
  { inputs: [], name: "LBPair__InvalidStaticFeeParameters", type: "error" },
  ...
  { inputs: [], name: "OracleHelper__LookUpTimestampTooOld", type: "error" },
  { inputs: [], name: "OracleHelper__NewLengthTooSmall", type: "error" },
  { inputs: [], name: "PackedUint128Math__AddOverflow", type: "error" },
  { inputs: [], name: "PackedUint128Math__MultiplierTooLarge", type: "error" },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint64", name: "cumulativeVolatility", type: "uint64" },
      { internalType: "uint64", name: "cumulativeBinCrossed", type: "uint64" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: "uint24", name: "volatilityAccumulator", type: "uint24" },
      { internalType: "uint24", name: "volatilityReference", type: "uint24" },
  ...
  },
  {
    ...
    name: "mint",
    outputs: [
      { internalType: "bytes32", name: "amountsReceived", type: "bytes32" },
